...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ email: err.response?.data?.message ?? 'Error al registrarse. Inténtalo de nuevo.' })
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="w-full max-w-md animate-fade-up">
        ...
        <div className="glass rounded-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Input label="Correo electrónico" type="email" placeholder="tu@ejemplo.com" required {...field('email')} />
            <Input label="Contraseña" type="password" placeholder="Mín. 6 caracteres" required {...field('password')} />
            <Input label="Confirma la contraseña" type="password" placeholder="Repite la contraseña" required {...field('confirm')} />
